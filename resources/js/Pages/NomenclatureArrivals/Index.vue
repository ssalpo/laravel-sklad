                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr v-for="(nomenclatureArrival, index) in nomenclatureArrivals.data">
                                ...
                                <td>{{nomenclatureArrival.price}} {{$page.props.shared.currencyTypeLabelsShort[nomenclatureArrival.currency_type]}}</td>
                                <td>{{nomenclatureArrival.price_for_sale}} {{$page.props.shared.currencyTypeLabelsShort[nomenclatureArrival.currency_type]}}</td>
