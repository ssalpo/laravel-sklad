                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-hover mb-4 mt-3">
                        <table width="250" border="1">
                            <tr>
                                <td class="p-1">Заявщик</td>
                                <td class="p-1">{{order.user}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="p-1">{{order.amount}} {{$page.props.shared.currencyTypeLabelsShort[order.currency_type]}}</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr v-for="(orderItem, index) in orderItems">
                                ...
                                <td>{{orderItem.price_for_sale * orderItem.quantity}} {{$page.props.shared.currencyTypeLabelsShort[order.currency_type]}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
